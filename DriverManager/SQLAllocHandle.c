                           ...
                           SQLINTEGER requested_version)
{
    ...
    case SQL_HANDLE_DBC:
    {
        int res = conn_part(handle_type, input_handle, (SQLHANDLE *)&(pm->conns[0]), requested_version);
        conn_part(handle_type, input_handle, (SQLHANDLE *)&(pm->conns[1]), requested_version);
        return res;
    }
    break;
    ...
    {
        int res = stmt_part(handle_type, (SQLHANDLE *)pm->conns[0], (SQLHANDLE *)&(pm->stmts[0]), requested_version);
        stmt_part(handle_type, (SQLHANDLE *)pm->conns[1], (SQLHANDLE *)&(pm->stmts[1]), requested_version);
        return res;
    }
    break;
