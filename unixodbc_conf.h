...
/* Install bindir */
#define BIN_PREFIX "/usr/local/unixODBC/bin"
...
/* Lib directory */
#define DEFLIB_PATH "/usr/local/unixODBC/lib"
...
/* Install exec_prefix */
#define EXEC_PREFIX "/usr/local/unixODBC"
...
/* Install includedir */
#define INCLUDE_PREFIX "/usr/local/unixODBC/include"

/* Lib directory */
#define LIB_PREFIX "/usr/local/unixODBC/lib"

/* Define if the OS needs help to load dependent libraries for dlopen(). */
/* #undef LTDL_DLOPEN_DEPLIBS */

/* Define to the system default library search path. */
#define LT_DLSEARCH_PATH "/lib:/usr/lib:/usr/lib/x86_64-linux-gnu/libfakeroot:/usr/local/lib:/usr/local/openssl/lib:/usr/local/unixODBC/lib:/usr/local/lib/x86_64-linux-gnu:/lib/x86_64-linux-gnu:/usr/lib/x86_64-linux-gnu:/lib32:/usr/lib32:/libx32:/usr/libx32:/usr/local/openssl/lib/"
...
/* Install prefix */
#define PREFIX "/usr/local/unixODBC"
...
/* System file path */
#define SYSTEM_FILE_PATH "/usr/local/unixODBC/etc"

/* Lib path */
#define SYSTEM_LIB_PATH "/usr/local/unixODBC/lib"
